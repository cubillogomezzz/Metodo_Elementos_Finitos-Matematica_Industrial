...
% crank-nicolson, condiciones dirichlet, neuman homog --- 
...
% Si hubiese neuman homo, simplemente no imponer dirichlet ahí
...
uhn = 0*xi' + 50; % Condicion inicial, cuidado hay que transponer xi
plot(xi,uhn);
title('0');
pause

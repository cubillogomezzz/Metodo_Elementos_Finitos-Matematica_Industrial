%  --- Elastodinámica con Newmark implícito, sin rozamiento --- 
...
% Resolución 
    ...
    % Inicialización, obtención a en t=0
      ...
      ai = M_barra\((M_barra*fi-A*ui)*(1/rho)); %(R sin imponerle condiciones, ya lo hace ui)
    ...
    % Iteración en tiempo
      for i=1:Ne_t
            ...
            vec_carg = M_barra*(rho*ui_ant + rho*dt*vi_ant + rho*0.5*dt^2*(1-2*beta)*ai_ant + beta*dt^2*fi); % Caracrterístico de problema y esquema
            vec_carg(fron_d) = 0;
